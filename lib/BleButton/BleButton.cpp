...
static const char DEVICE_NAME[]= "TEST-DEV";
static Ticker led_flipper;
static const uint8_t MSD[] = {(uint8_t)'T',(uint8_t)'D', 
...
static const Gap::ConnectionParams_t PREFFERED_CONNECTION_PARAMS = {24, 40, 1, 200}; 
